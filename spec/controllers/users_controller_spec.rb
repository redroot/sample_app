...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
		...
		30.times do
          @users << Factory(:user, :email => Factory.next(:email)) ## add 30 more users to the array
        end
      end
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      before(:each) do
        admin = Factory(:user, :email => "admin@example.com", :admin => true) # factories are not bound by the rules of attr_accessible
        test_sign_in(admin)
      end
